...
class _StartPageState extends State<StartPage>
  ...
  void initTabController(int index, List<Sport> sports) {
    tabController =
        TabController(initialIndex: index, length: sports.length, vsync: this);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(controller: tabController, children: _tabViews),
    );
  }
